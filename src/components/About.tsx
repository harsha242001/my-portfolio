  ...
  const milestones = [
    {
      ...
      description: "At ValueLabs, I drove healthcare automation with Java, enhancing operational efficiency through data mining tools, and delivered high-impact web automation solutions",
      icon: Calendar
    },
    {
      year: "2023",
      title: "Senior Software Engineer",
      description: "I developed PoC projects leveraging technologies like Python, Provar, and Playwright, enhancing my automation and development expertise.",
      icon: Award
    }
  ];
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-20 animate-slide-up">
            ...
            <p className="text-xl text-slate-300 max-w-4xl mx-auto leading-relaxed">
              Senior Software Engineer with specialized healthcare domain knowledge. With expertise in Java, Selenium, and Python, I develop scalable automation frameworks that streamline complex manual processes and enhance operational efficiency. I lead innovative projects, including data mining and cutting-edge proof-of-concept solutions, delivering high-impact results.  Passionate about continuous learning and collaboration, I thrive on driving technological and business innovation.
            </p>
          </div>
